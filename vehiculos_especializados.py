...
class VehiculoFerroviario(Vehiculo):
    def _init_(self, nombre):
        super()._init_(nombre, "ferroviaria", 100, 150000, 100, 15, 3)
...
class VehiculoAutomotor(Vehiculo):
    def _init_(self, nombre):
        super()._init_(nombre, "automotor", 80, 30000, 30, 5, 0)  # El costo por kg se calcula aparte
...
class VehiculoFluvial(Vehiculo):
    def _init_(self, nombre, tipo="fluvial"):
        super()._init_(nombre, tipo, 40, 100000, 500, 15, 2)
...
class VehiculoAereo(Vehiculo):
    def _init_(self, nombre):
        super()._init_(nombre, "aerea", 600, 5000, 750, 40, 10)
